...
export const SKILL_NODES: SkillNodeDef[] = [
  ...
  n("E1B", "electronics", 1, 1, "Habla con el microcontrolador", "sub",
    "Elige el recurso adecuado del microcontrolador (GPIO, ADC, PWM, UART, I2C, SPI) para cada situación.", ["E0"]),
  n("E2", "electronics", 2, 0, "Del sensor al motor", "aplicacion",
    "Completa la cadena sensor → microcontrolador → driver → actuador definiendo alimentación, pines e interfaz.", ["E1A", "E1B"]),
  n("E3A", "electronics", 3, -1, "Alimenta el robot", "profundizacion",
    "Dado un robot con motores, servos y sensores, selecciona la batería, reguladores y distribución de corriente.", ["E2"]),
  n("E3B", "electronics", 3, 1, "Debuggea el hardware", "profundizacion",
    "Diagnostica una falla de hardware: tierra no común, pull-up ausente, tensión incorrecta o dirección I2C equivocada.", ["E2"]),
  n("E4", "electronics", 4, 0, "Electrónica libre", "libre",
    "Construye o simula un sistema electrónico relacionado con robótica y adjunta evidencia.", ["E3A", "E3B"]),
